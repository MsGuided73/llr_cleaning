...
import { TrendingUp, Wallet, Receipt, Calendar, ArrowUpRight, ArrowDownRight, Plus, Sparkles } from 'lucide-react'
        ...
        <main className="main-content">
            ...
            <section className="space-y-8 pb-20">
                ...
                <div className="space-y-4">
                    ...
                    <div className="dimensional-card p-6 relative overflow-hidden">
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        <Link href="/finances/log">
                            <motion.button
                                whileTap={{ scale: 0.95 }}
                                className="dimensional-card p-5 w-full flex flex-col items-center gap-3 interactive-block"
                            >
                        ...
                        >
                            ...
                            <span className="text-[10px] font-black uppercase tracking-widest text-center">View Reports</span>
                        </motion.button>
                    </div>
                </div>
                    ...
                    <div className="space-y-3">
                        {transactions.map((tx) => (
                            <motion.div
                                key={tx.id}
                                whileTap={{ scale: 0.98 }}
                                className="dimensional-card p-5 flex items-center justify-between interactive-block"
                            >
